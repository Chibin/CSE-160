...
#line 737
typedef int (*__compar_fn_t)(const void *arg_0x2b86203276b0, const void *arg_0x2b8620327988);
#line 771
__extension__ 
#line 788
__extension__ 
...
#line 251
extern double erfc(double arg_0x2b862039c060) __attribute((__nothrow__)) ;
...
unsigned int (*hashfunction)(void *arg_0x2b86205d16a8), 
int (*key_eq_fn)(void *arg_0x2b86205d1e20, void *arg_0x2b86205cf100));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2b86207de0c8, int arg_0x2b86207de330);
static double RandomUniform(void );
...
# 9 "/home/maru/workspace1/SkeltonCode/src/dataStructures/pair.h"
#line 6
typedef struct pair {
  uint8_t src;
  uint8_t seq;
...
# 63 "/home/maru/workspace1/SkeltonCode/src/Node.nc"
...
#line 67
# 304 "/home/maru/workspace1/SkeltonCode/src/Node.nc"
static inline void Node$arrPrintList(arrlist *list)
#line 304
{
  uint8_t i;
...
#line 306
  for (i = 0; i < list->numValues; i++) {
      sim_log_debug(195U, "Project1N", "I think I am friends with %d and the last time we met was %d \n\n", list->values[i].src, list->values[i].seq);
    }
}
...
#line 118
{
  ...
  if (len == sizeof(pack )) {
      ...
      sim_log_debug(173U, "Project1F", "I AM A PACKET TO BE CHECKED! \n");
      sim_log_debug(174U, "Project1F", "Inside the packet is src:%d msg:%d seq:%d \n", __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->dest.nxdata), __nesc_ntoh_uint16(myMsg->seq.nxdata));
...
#line 137
              case PROTOCOL_PING: 
                sim_log_debug(176U, "genDebug", "Sending Ping Reply to %d! \n\n", __nesc_ntoh_uint16(myMsg->src.nxdata));
...
#line 152
                    case CMD_PING: 
                      sim_log_debug(179U, "genDebug", "Ping packet received: %d \n", __nesc_ntoh_uint16(myMsg->seq.nxdata));
...
#line 182
          if (__nesc_ntoh_uint16(myMsg->dest.nxdata) == Node$discoveryPacket[sim_node()]) {
              ...
              switch (__nesc_ntoh_uint8(myMsg->protocol.nxdata)) {
                  case PROTOCOL_PING: 
                    Node$makePack(&Node$sendPackage[sim_node()], TOS_NODE_ID, Node$discoveryPacket[sim_node()], MAX_TTL, PROTOCOL_PINGREPLY, Node$sequenceNum[sim_node()]++, (uint8_t *)myMsg->payload, sizeof  myMsg->payload);
                  ...
                  if (!arrListContains(&Node$friendList[sim_node()], __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->seq.nxdata))) {
                      ...
                      sim_log_debug(184U, "Project1N", "Adding to my FriendList anyways T_T \n\n");
                    }
                  else {
                      sim_log_debug(185U, "Project1N", "Oh you're already in my FriendList? :D");
                    }
                  Node$arrPrintList(&Node$friendList[sim_node()]);
                  break;
                  default: 
                    sim_log_debug(186U, "Project1N", "I should never get here, I hope. \n");
                  break;
                }
            }
          else 
            {
              ...
              sim_log_debug(187U, "Project1F", "I AM A PACKET FOR BROADCASTING \n");
              if (!arrListContains(&Node$Received[sim_node()], __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->seq.nxdata))) {
                  sim_log_debug(188U, "Project1F", "BroadCasting from %d SEQ#:%d DEST:%d \n", TOS_NODE_ID, __nesc_ntoh_uint16(myMsg->seq.nxdata), __nesc_ntoh_uint16(myMsg->dest.nxdata));
                  ...
                  Node$sendBufferTask$postTask();
                  sim_log_debug(189U, "Project1F", "Broadcasting\n\n");
                }
              else {

                  sim_log_debug(190U, "Project1F", "DROPPING packets with src:%d seq:%d \n", __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->seq.nxdata));
                  temp1 = back(&Node$Received[sim_node()]);
                  sim_log_debug(191U, "Project1F", "Size is %d seq# of last is %d\n\n", arrListSize(&Node$Received[sim_node()]), temp2.seq);
                }
            }
          }
        }
#line 236
  ...
  sim_log_debug(192U, "genDebug", "Unknown Packet Type\n");
  return msg;
}
...
# 78 "/home/maru/local/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2b8620c0a340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2b8620c0a340) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2b8620c0a340, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/maru/local/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2b8620c08020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2b8620c08020, msg, payload, len);
#line 78
...
#line 64
# 72 "/home/maru/workspace1/SkeltonCode/src/Node.nc"
static inline void Node$AMControl$startDone(error_t err)
#line 72
{
  if (err == SUCCESS) {
...
# 82 "/home/maru/workspace1/SkeltonCode/src/Node.nc"
static inline void Node$AMControl$stopDone(error_t err)
#line 82
{
}
...
# 110 "/home/maru/local/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2b8620bdd220, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2b8620bdd220, msg, error);
#line 110
}
#line 110
...
# 80 "/home/maru/local/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2b86211cf488, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x2b86211cf488, addr, msg, len);
#line 80
...
#line 126
# 269 "/home/maru/workspace1/SkeltonCode/src/Node.nc"
static inline error_t Node$send(uint16_t src, uint16_t dest, pack *message)
#line 269
{
...
#line 284
        {
          sim_log_debug(193U, "genDebug", "The radio is busy, or something\n");
          return FAIL;
        }
    }
  else 
#line 288
  ...
  sim_log_debug(194U, "genDebug", "FAILED!?");
  return FAIL;
}
...
# 243 "/home/maru/workspace1/SkeltonCode/src/Node.nc"
static inline void Node$sendBufferTask$runTask(void )
#line 243
{
...
# 100 "/home/maru/local/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2b86211d1318, message_t * msg, error_t error){
#line 100
  switch (arg_0x2b86211d1318) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2b86211d1318, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/maru/local/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2b86208f2ab0){
#line 75
  switch (arg_0x2b86208f2ab0) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2b86208f2ab0);
#line 75
      break;
#line 75
    }
...
# 84 "/home/maru/workspace1/SkeltonCode/src/Node.nc"
static inline void Node$pingTimeoutTimer$fired(void )
#line 84
{
...
#line 89
{
  ...
  Node$makePack(&Node$sendPackage[sim_node()], TOS_NODE_ID, Node$discoveryPacket[sim_node()], MAX_TTL, PROTOCOL_PING, Node$sequenceNum[sim_node()]++, (uint8_t *)createMsg, 
  sizeof createMsg);
...
# 83 "/home/maru/local/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2b862115bc28){
#line 83
  switch (arg_0x2b862115bc28) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2b862115bc28);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(222U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP$compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP$overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(221U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP$overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(218U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(219U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(211U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(201U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 194
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << OCIE0)) != 0) {
          ...
          sim_log_debug(207U, "HplAtm128Timer0AsyncP", "Compare interrupt @ %s\n", timeStr);
          INTERRUPT_15();
        }
      else {
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << OCF0;
...
#line 225
  sim_log_debug(208U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 364
{
  sim_log_debug(213U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
# 66 "/home/maru/workspace1/SkeltonCode/src/Node.nc"
static inline void Node$Boot$booted(void )
#line 66
{
  Node$AMControl$start();
...
# 295 "/home/maru/workspace1/SkeltonCode/src/Node.nc"
static void Node$makePack(pack *Package, uint16_t src, uint16_t dest, uint16_t TTL, uint16_t protocol, uint16_t seq, uint8_t *payload, uint8_t length)
#line 295
{
...
# 107 "/home/maru/workspace1/SkeltonCode/src/Node.nc"
static void Node$AMSend$sendDone(message_t *msg, error_t error)
#line 107
{
  ...
  if (&Node$pkt[sim_node()] == msg) {
      ...
      sim_log_debug(171U, "Project1F", "Broadcasted\n\n");
      Node$sendBufferTask$postTask();
    }
}
...
#line 285
  ...
  sim_log_debug(210U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(216U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 101
      sim_log_debug(196U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) {
              sim_log_debug(197U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(198U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$set[sim_node()]) {
          ...
          sim_log_debug(199U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(217U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(220U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(209U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
